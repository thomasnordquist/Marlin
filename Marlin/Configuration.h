...
#define STRING_CONFIG_H_AUTHOR "(Thomas Nordquist, Anet A8 RAMPS config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kermit"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 8, 120 }
...
#define HOMING_FEEDRATE_Z  (6*60) * 2
